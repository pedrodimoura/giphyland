    ...
    private fun mapRemoteModelToDomainModel(gifRemoteModels: List<GifRemoteModel>) =
        gifRemoteModels.map { gifRemoteModel ->
            Gif(
                ...
                updateDateTime = gifRemoteModel.updateDateTime,
                createDateTime = gifRemoteModel.createDateTime,
                importDateTime = gifRemoteModel.importDateTime,
                trendingDateTime = gifRemoteModel.trendingDateTime,
